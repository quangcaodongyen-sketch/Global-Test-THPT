...
export async function parseTemplateFile(file: File): Promise<TemplateFileData> {
  ...
  if (combinedText.includes('lớp 10') || combinedText.includes('tiếng anh 10') || combinedText.includes('grade 10') || combinedText.includes('anh 10') || combinedText.includes('k10') || combinedText.includes('khối 10')) {
    detectedGrade = 'Lớp 10';
  } else if (combinedText.includes('lớp 11') || combinedText.includes('tiếng anh 11') || combinedText.includes('grade 11') || combinedText.includes('anh 11') || combinedText.includes('k11') || combinedText.includes('khối 11')) {
    detectedGrade = 'Lớp 11';
  } else if (combinedText.includes('lớp 12') || combinedText.includes('tiếng anh 12') || combinedText.includes('grade 12') || combinedText.includes('anh 12') || combinedText.includes('k12') || combinedText.includes('khối 12')) {
